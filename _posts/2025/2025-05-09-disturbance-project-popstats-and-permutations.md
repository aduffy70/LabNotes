...
---
Notes:
  * I realized I filtered the dataset incorrectly for the popstats analyses! I filtered loci with more or less than 2 loci before I filtered out the admin samples so I had many loci that were not polymorphic in the final sampleset. This doesn't affect Fst but it changes the Hexp, PPL, and PPR results dramatically. I fixed it.
